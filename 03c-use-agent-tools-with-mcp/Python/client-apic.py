# Note: Lab Completed 9/11/2025
# Instruction: https://github.com/MicrosoftLearning/mslearn-ai-agents/blob/main/Instructions/03c-use-agent-tools-with-mcp.md
# Connect AI agents to tools using Model Context Protocol (MCP)
#  - an agent that uses an MCP server to do client management
#    "https://mcp-client-management-func.azurewebsites.net/runtime/webhooks/mcp/sse?code=..."
...
with agents_client:
    ...
    try:
        agent = agents_client.create_agent(
            ...
            name="my-mcp-agent2",
            instructions="""
            You have access to an MCP server called `McpServerClientManagement` - this tool allows you to 
            manage client information. Use the available MCP tools 
        ...
        print("1. Check that your model deployment name is correct")
        print("2. Verify you have access to the AI Foundry project")
        print("3. Ensure you're authenticated with the correct Azure tenant")
        exit(1)
    ...
    while True:
        ...
        print(f"      [3] Created message, ID: {message.id}")
        ...
        try:
            ...
            print(f"          [4] Created run, ID: {run.id}")
