...
# Instruction: https://github.com/MicrosoftLearning/mslearn-ai-agents/blob/main/Instructions/03d-use-local-mcp-server-tools.md
# create an agent that can connect to an MCP server and automatically discover callable functions.
