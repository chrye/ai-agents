# Note: Lab Completed 9/19/2025
# Instruction: https://github.com/MicrosoftLearning/mslearn-ai-agents/blob/main/Instructions/03b-build-multi-agent-solution.md
# Build a multi-agent solution -> 
# orchestrates multiple AI agents using Azure AI Foundry Agent Service
#  - an agent to prioritize support tickets,
#  - an agent to assign tickets to the appropriate team
#  - an agent to estimate effort for a support ticket
#  - connected agent tools (one agent tool per agent) for the support agents,
#  - a primary agent to triage support tickets by using the other agents as connected tools
